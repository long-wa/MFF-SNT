...
# ==== enhance parameter ============
__C.FPN = CN()
__C.FPN.IN_CHANNELS = [0, 512, 1024, 2048]
__C.FPN.OUT_CHANNELS = 256
__C.FPN.USE_GN = False
__C.FPN.USE_RELU = False
__C.FPN.IN_CHANNELS_P6P7 = 256

__C.HEAD = CN()
__C.HEAD.NEED_WEIGHT = ['p3', 'p4', 'p5']
__C.HEAD.IN_CHANNEL = [256, 256, 256, 256, 256]
__C.HEAD.CLS_OUT_CHANNEL = 2

__C.POINT = CN()
__C.POINT.STRIDE = [8, 16, 32]
__C.POINT.TRAIN_OUTPUT_SIZE = [17, 9, 5]

__C.FOCAL_LOSS = CN()
__C.FOCAL_LOSS.ALPHA = 0.25
__C.FOCAL_LOSS.GAMMA = 2.0
__C.FOCAL_LOSS.REDUCTION = "mean"