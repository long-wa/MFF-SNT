...
import sys
import json
sys.path.append('D:/课题2/previous/code_use/siamban-master_new')
...
args.video_name='D:/opencv/video_result/scale3.avi'
# --------------------------------------------------------------------------------- #
...
def main():
    ...
    i=0
    # =============== 结果保存在json文件中 ========================
    json_path = '../my_experiments/scale3_result.json'
    dictionary = {}
    ...
    for frame in get_frames(args.video_name):
        if first_frame:
            ...
            if 'polygon' in outputs:
                ...
                # dictionary['number_frame_'+str(i)+''] = [bbox[0], bbox[1], bbox[0]+bbox[2], bbox[1]+bbox[3]]

                # ================== 保存原demo结果 ==============
                # cv2.imwrite('D:/subject2/scale3_result/{}.jpg'.format(i), frame)
                # i += 1
